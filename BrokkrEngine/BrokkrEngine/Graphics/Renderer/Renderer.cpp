...
void Brokkr::Renderer::SetRenderDrawColor(const Color* pColor) const
{
    SDL_SetRenderDrawColor
    (
        m_pRenderer,
        static_cast<Uint8>(pColor->m_red),
        static_cast<Uint8>(pColor->m_green),
        static_cast<Uint8>(pColor->m_blue),
        static_cast<Uint8>(pColor->m_opacity)
    );
}
